...
@section('content')
    ...
    @endif
    <div><a href="{{$post->getUrl()}}" target="_blank">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" class="form-control my-editor" rows="15">{{ $post->description }}</textarea>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                    ...
                    <div class="checkbox">
                        ...
                        <option value="{{$post->Cate->id}}">{{$post->Cate->category}}
                        </option>
                            <?php  menu($data);?>
                        </select>
                    </div>
