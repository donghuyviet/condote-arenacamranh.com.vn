<div id="my-id-form" class="uk-modal">
    <div class="uk-modal-dialog form-summit uk-modal-dialog-lightbox">
		...
		<div class="desc"> Hệ thống của chúng tôi sẽ gửi toàn bộ bảng giá chi tiết bảng giá, chính sách mới nhất vào email và số điện thoại cho quý khách trong vòng 1-3 phút làm việc.</div>
