...
class FrontendController extends Controller
{
    ...
    public function tinTucChiTiet($id){
        ...
        $hotPost = Post::where([['hot',1],['is_hidden','0']])->orderBy('id', 'DESC')->limit(6)->get();
        // echo "<pre>";
        // print_r($hotPost);
        // echo "</pre>";
    ...
    public function contactSubmit(ContactRequest $request){
        ...
        try {
            Mail::to('donghuyviet.bds@gmail.com')->cc(['phucxuannguyen2468@gmail.com'])->send(new \App\Mail\NewParagonCustomer($customer));
        } catch (\Swift_TransportException $e) {
        }

        // try {
        //     Mail::to('donghuyviet.bds@gmail.com')->send(new \App\Mail\NewParagonCustomer($customer));
        // } catch (\Swift_TransportException $e) {
        // }
